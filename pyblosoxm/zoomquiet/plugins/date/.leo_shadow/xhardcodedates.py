#@+leo-ver=4-thin
#@+node:zoomq.20100419111908.3742:@shadow hardcodedates.py
#@@language python
#@@tabwidth -4
# -*- coding: utf-8 -*-
...
#@+others
#@+node:zoomq.20100419111908.3743:hardcodedates declarations
...
__version__ = '1.4'
#@-node:zoomq.20100419111908.3743:hardcodedates declarations
#@+node:zoomq.20100419111908.3744:init
def init(request):
    if all_timestamps:
...
#@-node:zoomq.20100419111908.3744:init
#@+node:zoomq.20100419111908.3745:cb_filestat
...
#@-node:zoomq.20100419111908.3745:cb_filestat
#@+node:zoomq.20100419111908.3746:cb_end
def cb_end(args):
