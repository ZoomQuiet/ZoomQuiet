#@+leo-ver=4-thin
#@+node:zoomq.20100414115206.4692:@shadow index.py
#@@language python
#@@tabwidth -4
#@+others
#@+node:zoomq.20100414115206.4693:index declarations
"""
index.py
...
#@-node:zoomq.20100414115206.4693:index declarations
#@+node:zoomq.20100414115206.4694:verify_installation
def verify_installation(request):
  return 1

#@-node:zoomq.20100414115206.4694:verify_installation
#@+node:zoomq.20100414115206.4695:cb_filelist
...
#@-node:zoomq.20100414115206.4695:cb_filelist
#@+node:zoomq.20100414115206.4696:cb_story
def cb_story(args):
  request = args['request']
  http = request.getHttp()
  config = request.getConfiguration()
