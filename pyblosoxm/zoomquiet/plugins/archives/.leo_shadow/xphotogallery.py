#@+leo-ver=4-thin
#@+node:zoomq.20100419111908.3747:@shadow photogallery.py
#@@language python
#@@tabwidth -4
# -*- coding: utf-8 -*-

#@+others
#@+node:zoomq.20100419111908.3748:photogallery declarations
...
#@-node:zoomq.20100419111908.3748:photogallery declarations
#@+node:zoomq.20100419111908.3749:verify_installation
...
#@-node:zoomq.20100419111908.3749:verify_installation
#@+node:zoomq.20100419111908.3750:cb_filelist
def cb_filelist(args):
    ...
    if pyhttp["PATH_INFO"] == trigger or pyhttp["PATH_INFO"] == trigger + "/" :
        #@        <<if_pyhttp>>
        #@+node:zoomq.20100419111908.3752:<<if_pyhttp>>
        ...
        #@        <<elif_pyhttp>>
        #@+node:zoomq.20100419111908.3753:<<elif_pyhttp>>
...
#@-node:zoomq.20100419111908.3750:cb_filelist
#@+node:zoomq.20100419111908.3751:cb_story
def cb_story(args):
    request = args['request']
