#@+leo-ver=4-thin
#@+node:zoomq.20100414115206.4702:@shadow index_static.py
#@@language python
#@@tabwidth -4
# -*- coding: utf-8 -*-
#@+others
#@+node:zoomq.20100414115206.4703:index declarations
"""
index_static.py
...
#@-node:zoomq.20100414115206.4703:index declarations
#@+node:zoomq.20100414115206.4704:verify_installation
def verify_installation(request):
  return 1

#@-node:zoomq.20100414115206.4704:verify_installation
#@+node:zoomq.20100414115206.4705:cb_filelist
...
#@-node:zoomq.20100414115206.4705:cb_filelist
#@+node:zoomq.20100414115206.4706:cb_story
def cb_story(args):
  request = args['request']
  http = request.getHttp()
  config = request.getConfiguration()
