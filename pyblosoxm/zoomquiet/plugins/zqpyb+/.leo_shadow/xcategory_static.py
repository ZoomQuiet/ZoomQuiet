#@+leo-ver=4-thin
#@+node:zoomq.20100420100426.5124:@shadow category_static.py
#@@language python
#@@tabwidth -4
# -*- coding: utf-8 -*-
#@<<declarations>>
#@+node:zoomq.20100420100426.5125:<<declarations>>
"""
category_static.py
...
DEFAULT_ROOT = []
#@+others
#@+node:zoomq.20100420100426.5126:verify_installation
def verify_installation(request):
  return 1

#@-node:zoomq.20100420100426.5126:verify_installation
#@+node:zoomq.20100420100426.5127:cb_filelist
def cb_filelist(args):
    ...
    #@    @+others
    #@+node:zoomq.20100420100426.5129:gen_dict
    #print files
    ...
    #@nonl
    #@-node:zoomq.20100420100426.5129:gen_dict
    #@+node:zoomq.20100420100426.5130:gen_tree
    #print _baseurl
    etree = {}
    """{
    ...
    '''
    #@-node:zoomq.20100420100426.5130:gen_tree
    #@+node:zoomq.20100514091552.4530:gen_html
    body += '<h3>/</h3>'
    for e in etree[''][1:]:
    ...
    for k in root_entry_list:
        ...
        for p in k[1]:
            #print etree[p]
            #@        <<item link>>
            #@+node:zoomq.20100514091552.4532:<<item link>>
...
#@-node:zoomq.20100420100426.5127:cb_filelist
#@+node:zoomq.20100420100426.5128:cb_story
def cb_story(args):
  request = args['request']
  http = request.getHttp()
  config = request.getConfiguration()
