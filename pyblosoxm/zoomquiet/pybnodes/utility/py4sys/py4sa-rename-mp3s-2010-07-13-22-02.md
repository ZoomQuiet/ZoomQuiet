\[Py4SA\]批量文件重命名 \--远离Shell 的试探 t2t渲染:: 2024-07-27

# 问题

嗯嗯嗯,最近从 六哥的 DUKU 重新激发了评书的记忆,下载了全本
袁阔成(40回)红岩魂的mp3 ;-)
...
-   绝对好书! 值得慢慢看,E文的也非常简洁,Py
    清明的代码,直接看,尝试就可以体会到本意了\...
...
3.  rename \... NGU/Linux
    中的标准化重命名工具,但是,怎么可以将批量文件中指定前几个字符替换成指定字符?
