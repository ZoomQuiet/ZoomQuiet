...
-   [从Dapper到Feisty
    的征程](http://blog.zoomquiet.org/pyblosxom/FLOSS/Ubuntu/upgrade-into-feisty-2007-05-11-13-43)
...
2.  不论作者如何\`\`ReiserFS\`\` 绝对是个人用户的守护神哪！
3.  不论多没可能使用，系统的DVD 光盘一定要带在身边！特别是Ubuntu
    系统安装DVD，紧急情况下可以作为LiveCD 直接进行工作的！
...
![](/pybimage/technorati-over.gif) ,\[OpenSource
<http://www.technorati.com/tags/OpenSource>\] ,\[Ubuntu
<http://www.technorati.com/tags/Ubuntu>\]
