FF2GG \-- 7.04 Feisty Fawn 到7.10 Gutsy Gibbon
...
1.  WiFi 怎么也不能连接到公司的AP中,研究中;家里的 6.06
    也得整了\...p2p下载已经停了些日子了\...
2.  VBox 带个能用网银的系统,也得整! 不想再多系统启动了,就Ubuntu!
3.  [XFS
    是个蒙事儿的主](http://www.ibm.com/developerworks/cn/linux/l-jfs/),还是得经典的FS才成哪!
    周末准备回写成 ReiserFS
